    ...
    showDialog(
      ...
      builder:
          (_) => AlertDialog(
            ...
            content: const Text(
              "Souhaitez-vous retirer ce contact de la liste des invités ?",
            ),
            actions: [
              TextButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Get.to(
            () => ListeContactsPage(database: database, event: event),
          );
          _loadInvitedContacts(); // Recharge après retour
        },
        backgroundColor: appTheme.appSlightViolet,
